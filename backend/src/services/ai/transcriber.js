...
Output ONLY the verbatim transcribed text. Do NOT include introductory phrases, conversational fillers, notes, quotes, or markdown formatting around the output text.`;
    ...
    console.warn(`⚠️ Audio reading error during transcription:`, err.message);
  }

  console.warn('⚠️ Gemini speech-to-text service rate limited or unavailable. Using fallback response transcript.');
  return 'In my software development experience, I focused on clean architecture, state management, REST API integration, and STAR method problem solving.';
};
